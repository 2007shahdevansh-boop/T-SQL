...
SELECT CITY,SUM(CITY) FROM EMPLOYEE
GROUP BY CITY 
...
SELECT  CITY,COUNT(CASE WHEN GENDER='MALE' THEN EID ELSE NULL END) AS MALE,COUNT(CASE WHEN GENDER='FEMALE' THEN EID ELSE NULL END) AS FEMALE FROM EMPLOYEE
GROUP BY CITY
...
SELECT DEPARTMENT,COUNT(CITY) FROM EMPLOYEE
GROUP BY DEPARTMENT
HAVING COUNT(CITY)>1
...
SELECT DEPARTMENT,SUM(CASE WHEN GENDER='MALE' THEN SALARY ELSE 0 END) AS MALE,SUM(CASE WHEN GENDER='FEMALE' THEN SALARY ELSE 0 END) AS FEMALE  FROM EMPLOYEE
WHERE GENDER='MALE'
GROUP BY DEPARTMENT
