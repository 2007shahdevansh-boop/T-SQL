...
-- Insert Data into ONLINE_CUSTOMER Table
...
-- Insert Data into OFFLINE_CUSTOMER Table
...
SELECT Name,CID,CITY FROM ONLINE_CUSTOMER
UNION
SELECT Name,CID,CITY FROM CUSTOMER
...
SELECT Name,CID,CITY FROM OFFLINE_CUSTOMER
UNION
SELECT Name,CID,CITY FROM CUSTOMER
UNION 
SELECT Name,CID,CITY FROM ONLINE_CUSTOMER
